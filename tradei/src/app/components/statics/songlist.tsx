                    ...
                    <tbody>
                        {topSongs?.items?.map((song: any, index: number) => (
                            ...
                            <tr className="border-b border-zinc-900 text-white" key={index}>
                                ...
                                <td className="py-2 px-4 text-xs md:text-lg"><Link className="flex flex-col items-center text-center" href={song.external_urls.spotify}><FaSpotify className="fill-green-500" ></FaSpotify> Open with Spotify <VscLinkExternal className="fill-green-500"></VscLinkExternal></Link></td>
                            </tr>
